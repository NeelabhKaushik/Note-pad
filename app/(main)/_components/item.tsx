...
const Item = ({
  ...
  const onArchive = (event: any) => {
    ...
    toast.promise(promise, {
      ...
      error: "Filed to archive note.",
    });
  };

  const handelExpand = (event: any) => {
    event.stopPropagation();
    onExpand?.();
  };
  ...
  return (
    ...
    >
      {!!id && (
        <div
          role="button"
          className="h-full rounded-sm hover:bg-neutral-300 dark:bg-neutral-6-- mr-1"
        ...
        <div className="ml-auto flex items-center gap-x-2">
          <DropdownMenu>
            ...
            >
              ...
              <DropdownMenuSeparator />
              <div className="text-xs text-muted-oreground p-2">
